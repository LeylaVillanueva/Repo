...
const AdminLayout = () => {
  return (
    <>
      <header>
        <Navbar fluid rounded style={{backgroundColor:""}}>
          <Navbar.Brand href="https://flowbite-react.com">
            ...
            <span className="self-center whitespace-nowrap text-xl font-semibold dark:text-white">Aquí esta un Navbar</span>
          </Navbar.Brand>
          <div className="flex md:order-2">
            ...
            >
              <Dropdown.Header>
                <span className="block text-sm">Ley</span>
                <span className="block truncate text-sm font-medium">leylavillanueva0205@gmail.com</span>
              </Dropdown.Header>
            ...
            <Sidebar.Items>
              <Sidebar.ItemGroup>
                ...
                <Sidebar.Collapse icon={HiShoppingBag} label="E-commerce">
                  ...
                  <Sidebar.Item href="#">Ventas</Sidebar.Item>
                  <Sidebar.Item href="#">Reembolsos</Sidebar.Item>
                  <Sidebar.Item href="#">Envíos</Sidebar.Item>
                </Sidebar.Collapse>
                <li>
                  <Link to={"dashboard"} className="flex items-center justify-center rounded-lg p-2 text-base font-normal text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                  ...
                  <span className="px-3 flex-1 whitespace-nowrap">Usuarios</span>
                  </Link>
                </li>
                <li>
                  <Link to={"dashboard"} className="flex items-center justify-center rounded-lg p-2 text-base font-normal text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                  ...
                  <span className="px-3 flex-1 whitespace-nowrap">Productos</span>
                  </Link>
                </li>
